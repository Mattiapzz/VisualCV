...
\begin{minipage}[t]{0.52\textwidth} % 40% of the page width for the introduction text
	\vspace{-\baselineskip} % Required for vertically aligning minipages
%
I am a passionate, pragmatic and goal-driven mechatronics engineer always looking for personal growth opportunities and challenges. This drove me in my academic choices and gave me the opportunity to approach the world of autonomous driving.
To pursue my passion I became a researcher where I had the opportunity to work on optimal control problem and algorithm development for ADAS both in collaboration with racing and industrial world.
My multidisciplinary education allow me to address problems both from the physical and theoretical foundation and its technical implementation. \\
